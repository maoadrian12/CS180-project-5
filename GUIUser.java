...
public class GUIUser {
    ...
    public GUIUser(String email, String password) {
        this.email = email;
    ...
    public static GUIUser logIn() {
        try {
            ...
            /*if (!existingUser) {
                do {
                    try {
                        tryAgain = JOptionPane.showConfirmDialog(null, "Attempt Login Again?",
                                "Log In", JOptionPane.YES_NO_OPTION);
                        break;
                    } catch (InputMismatchException e) {
            ...
            if (buyerOrSeller.equals("buyer")) {
                ...
                return new GUISeller(loginEmail, loginPassword);
            } else {
                return new GUIUser();
            }
        } catch (Exception e) {
    ...
    public static GUIUser signUp() {
        ...
        if (userData[2].equals("seller")) {
            GUISeller seller = new GUISeller(userData[0], userData[1]);
            return seller;
